...
frappe.ui.form.on("Prom Settings", {
	...
	import_prom_prod: function(frm){
        frappe.call({
            method: "webshop.webshop.doctype.prom_integ.prom_to_erp_prod.main",
            freeze: true,
	...
	get_order: function(frm) {
		frappe.call({
            method: "webshop.webshop.doctype.prom_integ.orders_get.get_all_orders", 
            freeze: true,
    ...
    get_new_order: function(frm) {
		frappe.call({
            method: "webshop.webshop.doctype.prom_integ.orders_get.check_for_new_orders", 
            freeze: true,
            freeze_message: "Fetching orders"
        });  
	},
	...
	export_prom_prod: function(frm) {
	    frappe.call({
            method: "webshop.webshop.doctype.prom_integ.erp_to_prom_prod.run",
            freeze: true,
